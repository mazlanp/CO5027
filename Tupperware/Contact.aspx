<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Tupperware.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Tupperware.Contact" %>
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="Name"></asp:Label>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail" ErrorMessage="*Invalide email" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
&nbsp;<asp:textbox runat="server" id="txtEmail"></asp:textbox>

		&nbsp;<asp:Label ID="Label3" runat="server" Text="Subject"></asp:Label>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSubject" ErrorMessage="*Subject is required" ForeColor="Red"></asp:RequiredFieldValidator>
		<asp:textbox runat="server" id="txtSubject"></asp:textbox>
	
		<asp:Label ID="Label4" runat="server" Text="Message"></asp:Label>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMsg" ErrorMessage="*You can't leave this empty" ForeColor="Red"></asp:RequiredFieldValidator>
